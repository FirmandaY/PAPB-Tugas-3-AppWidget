package com.example.appwidgettrial;
...
public class NewAppWidget extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        Intent intenUpdate = new Intent(context, NewAppWidget.class);
        intenUpdate.setAction(AppWidgetManager.ACTION_APPWIDGET_UPDATE);

        int [] idsArray = new int[] {appWidgetId};
        intenUpdate.putExtra(AppWidgetManager.EXTRA_APPWIDGET_IDS, idsArray);

        PendingIntent pendingUpdate = PendingIntent.getBroadcast(context, appWidgetId, intenUpdate, PendingIntent.FLAG_UPDATE_CURRENT);
